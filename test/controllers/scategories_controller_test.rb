...
class ScategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scategory" do
    assert_difference('Scategory.count') do
      post scategories_url, params: { scategory: { description: @scategory.description, display_in_navbar: @scategory.display_in_navbar, name: @scategory.name } }
    end
  ...
  test "should update scategory" do
    patch scategory_url(@scategory), params: { scategory: { description: @scategory.description, display_in_navbar: @scategory.display_in_navbar, name: @scategory.name } }
