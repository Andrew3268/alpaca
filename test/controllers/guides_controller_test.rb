...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { description: @guide.description, display_in_navbar: @guide.display_in_navbar, name: @guide.name } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { description: @guide.description, display_in_navbar: @guide.display_in_navbar, name: @guide.name } }
